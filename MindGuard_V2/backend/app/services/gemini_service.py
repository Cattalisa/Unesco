...
class GeminiService:
    ...
    async def analyze_text(self, text: str, language: str = "English") -> MindGuardReport:
        if not text.strip():
        ...
        prompt = (
            ...
            "Highlight the specific text snippets. Provide a highly detailed, comprehensive, and in-depth explanation "
            "for why each snippet is manipulative, analyzing the psychological intent behind it. "
            "Provide very practical and actionable critical thinking tips. "
            f"IMPORTANT: You MUST write your entire analysis and all explanations in {language} language."
        )
